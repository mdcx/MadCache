 ...
 */
define('BASE_PATH', dirname(__FILE__) . '/data');
class MadCache
{
	...
	const CACHE_PATH = BASE_PATH; // path to cache folder
	 ...
	 */
	const CACHE_NO_SUBDOMAINS = TRUE;
	...
	public function start_cache($EXPIRE, $KEY=NULL, $CHECK_ONLY=FALSE)
	{
		...
		{
			if ( $this->_default_key == TRUE || strpos($this->_original_key,'::') === false )
			{
