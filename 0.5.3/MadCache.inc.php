...
class MadCache
{
	...
	const CACHE_PATH = "/home/web1/mad_cache/cache_files"; // path to cache folder
	...
	const CACHE_STORAGE_PERM = 0777; // Default permissions of a cache storage directory. Be careful with 0700 etc if you can't override apache.
